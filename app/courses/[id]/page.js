...
const courseDetails = {
  react: {
    ...
    content: 'In this course, you will learn the fundamentals of React including components, hooks, and state management...',
    image: '/svg/react.svg',
    duration: '8 weeks',
    price: '99',
    instructor: {
    ...
    reviews: [
      { name: 'Jane Smith', comment: 'Great course, very informative!', date: '2024-01-15' },
      { name: 'Bob Brown', comment: 'Helped me improve my React skills significantly.', date: '2024-02-20' },
    ],
  },
  python: {
    title: 'Python',
    description: 'Python is an interpreted, high-level programming language...',
    content: 'This course covers Python programming basics, object-oriented programming, and advanced concepts like file handling and web scraping...',
  ...
  flutter: {
    ...
    content: 'In this course, you will learn how to build modern, cross-platform applications using Flutter, including widgets, state management, and navigation.',
    ...
    reviews: [
      { name: 'Mark Davis', comment: 'Loved building my first app with Flutter!', date: '2024-03-18' },
    ],
  },
  mernStack: {
    title: 'MERN Stack',
    description: 'The MERN stack consists of MongoDB, Express.js, React, and Node.js and is used to build powerful, full-stack web applications.',
    content: 'This course will take you through building a complete web application using the MERN stack, covering backend development, frontend design, and integration.',
    image: '/svg/mern.svg',
    duration: '12 weeks',
    price: '149',
    instructor: {
    ...
    reviews: [
      { name: 'Sarah Lee', comment: 'A complete and well-structured course on MERN stack!', date: '2024-04-05' },
    ],
  },
  nodejs: {
    title: 'Node.js',
    description: 'Node.js is a JavaScript runtime built on Chrome\'s V8 JavaScript engine. It allows you to build scalable server-side applications.',
    content: 'This course covers server-side programming using Node.js, including modules, event-driven programming, and building REST APIs.',
  ...
  htmlCssJs: {
    ...
    description: 'This course introduces you to the core building blocks of web development: HTML, CSS, and JavaScript.',
    content: 'Learn the basics of web development by building websites with HTML for structure, CSS for styling, and JavaScript for interactivity.',
    ...
    reviews: [
      { name: 'Tom Richards', comment: 'A great start for beginner web developers!', date: '2024-02-11' },
    ],
  },
  digitalMarketing: {
    title: 'Digital Marketing',
    description: 'This course covers the key principles and strategies used in digital marketing, including SEO, social media marketing, and email campaigns.',
    content: 'Learn how to effectively promote products or services online using various digital marketing techniques and tools.',
    ...
    reviews: [
      { name: 'Anna Bell', comment: 'Very helpful for getting started in digital marketing!', date: '2024-03-05' },
    ],
  },
};
