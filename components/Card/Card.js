...
const Card = ({ imgUrl, jobTitle, platform, text, tag, currency }) => {
  return (
    <div className='bg-white text-slate-600 hover:bg-secondary hover:text-white p-6 rounded-lg w-[350px] drop-shadow-2xl'>
      <div className='flex gap-6 mb-6'>
        <Image src={imgUrl} className='text-black w-[50px]' alt='Card Img'/>
