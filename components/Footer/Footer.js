...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-background pb-10 pt-10 dark:bg-background-dark lg:pb-10 lg:pt-[20px]">
  ...
  <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
    <div class="sm:col-span-2">
      ...
      <div class="mt-6 lg:max-w-sm">
        <p class="text-sm text-gray-800 dark:text-background">
          Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam.
        </p>
        <p class="mt-4 text-sm text-gray-800 dark:text-background">
    ...
    <div class="space-y-2 text-sm">
      ...
      <div class="flex">
        ...
        <a href="https://www.google.com/maps" target="_blank" rel="noopener noreferrer" aria-label="Our address" title="Our address" class="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800 dark:text-quaternary">
          312 Lovely Street, NY
        </a>
      </div>
    </div>
    <div>
      <span class="text-base font-bold tracking-wide text-gray-900 dark:text-background">Social</span>
      <div class="flex items-center mt-1 space-x-3">
        <a href="/" aria-label="twitter" class="text-gray-500 dark:text-quaternary transition-colors duration-300 hover:text-deep-purple-accent-400">
        ...
        <a href="/" aria-label="facebook" class="text-gray-500 dark:text-quaternary transition-colors duration-300 hover:text-deep-purple-accent-400">
          <svg viewBox="0 0 24 24" fill="currentColor" class="h-5">
            <path
      ...
      <p class="mt-4 text-sm text-gray-500 dark:text-background">
        Bacon ipsum dolor amet short ribs pig sausage prosciutto chicken spare ribs salami.
      </p>
    </div>
  </div>
  <div class="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
    <p class="text-sm text-gray-600 dark:text-background">
      © Copyright 2020 Lorem Inc. All rights reserved.
    </p>
    <ul class="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
      <li>
        <span href="/"   class="text-sm text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400 dark:text-background">F.A.Q</span>
      </li>
      <li>
        <span href="/"  class="text-sm text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400 dark:text-background">Privacy Policy</span>
      </li>
      <li>
        <span href="/" class="text-sm text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400  dark:text-background">Terms &amp; Conditions</span>
      </li>
    </ul>
  </div>
