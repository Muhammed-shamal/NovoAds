      ...
      <div className="hidden sm:mb-8 sm:flex sm:justify-center">
        ...
        <div className="text-center">
          ...
          <h1 className="font-poppins text-2xl font-medium tracking-tight text-secondary dark:text-background sm:text-5xl">
            <span className="block leading-tight">Innovate, Learn, and Connect</span>
            <span className="block leading-relaxed">
              With a
              <Cover ><strong className="dark:text-quaternary text-tertiary p-2"> Unified IT Solution</strong></Cover>
            </span>
          </h1>

          {/* Hero Subtext */}
          <p className="mt-6 text-md leading-8 text-primary dark:text-background">
            At Corvoso Technologies, we believe that your journey into the IT industry begins here. We are a forward-thinking startup committed to equipping aspiring professionals with the skills and knowledge they need to thrive in today&apos;s fast-paced tech world.
          </p>
          <p className="mt-4 text-md leading-8 text-primary dark:text-background">
            Whether you&apos;re a student, a fresh graduate, or a professional looking to upskill, Corvoso Technologies offers an engaging and supportive environment to launch or accelerate your career in IT.
          </p>
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            ...
            <a href="#" className="text-sm font-semibold leading-6 text-gray-900 dark:text-background">
